...
[![Lucro Certo](https://img.shields.io/badge/Produto_em_Prod-lucrocerto.cloud-22c55e?style=for-the-badge)](https://lucrocerto.cloud)
...
Software Developer Intern at **Fagron Tech** and Founder of **[Aithos Tech](https://lucrocerto.cloud)**, building and maintaining software in production.

Focus on **system stability**, **Root Cause Analysis (RCA)** and **API integration** connecting technical depth with business impact. Working on incident investigation, REST/GraphQL integrations, SQL/Firebird queries, RabbitMQ monitoring, and maintaining **[lucrocerto.cloud](https://lucrocerto.cloud)** in production.
...
**[Lucro Certo](https://lucrocerto.cloud)** is a smart pricing and financial management SaaS built and maintained by me, for food businesses (restaurants, food trucks, bakeries, dark kitchens).
...
flowchart TB
    ...
    subgraph EDGE["Edge Middleware"]
        ...
        E5 -->|nao| EHDRS
        EFAST --> EHDRS
        EHDRS["Headers: CSP - HSTS - X-Frame-Options"]
    end
    ...
    subgraph SEC["Seguranca - Defesa em Camadas"]
        ...
        S3["Camada 3 - Banco: RLS por usuario - operacoes privilegiadas via service role"]
        S1 --> S2 --> S3
    end
    ...
    subgraph SB["Supabase - Postgres com RLS"]
        DB[("usuarios - assinaturas - produtos - vendas - custos_fixos - pedidos_ifood - historico_chat - audit_logs - consentimentos_lgpd")]
    end
